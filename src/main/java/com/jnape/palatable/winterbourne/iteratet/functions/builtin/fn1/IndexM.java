...
import com.jnape.palatable.winterbourne.iteratet.functions.builtin.fn2.ZipM;
...
import static com.jnape.palatable.winterbourne.iteratet.functions.builtin.fn2.ZipM.zipM;
...
public final class IndexM<M extends MonadRec<?, M>, A> implements Fn1<IterateT<M, A>, IterateT<M, Tuple2<Integer, A>>> {
    ...
    public IterateT<M, Tuple2<Integer, A>> checkedApply(IterateT<M, A> as) throws Throwable {
        ...
        return ZipM.zipM(NaturalNumbersM.naturalNumbersM(Pure.of(unwrapped)), iterateT(unwrapped));
    }
