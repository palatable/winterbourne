...
import static com.jnape.palatable.winterbourne.iteratet.functions.builtin.fn1.CycleM.cycleM;
import static com.jnape.palatable.winterbourne.iteratet.functions.builtin.fn2.MagnetizeByM.magnetizeByM;
...
public final class InGroupsOfM<M extends MonadRec<?, M>, A>
    ...
    public IterateT<M, IterateT<M, A>> checkedApply(Integer k, IterateT<M, A> mas) throws Throwable {
        ...
        return magnetizeByM((t1, t2) -> eq(t1._1(), t2._1()), ZipM.zipM(EchoM.echoM(k, cycleM(IterateT.of(unwrapped.pure(true), unwrapped.pure(false)))), mas))
