...
/**
 * Returns the a {@link StreamT} of all the skips and emissions of the given {@link StreamT} except for the first
 ...
 */
public class TailM<M extends MonadRec<?, M>, A> implements Fn1<StreamT<M, A>, StreamT<M, A>> {
